 ...
 */
public class ItemHotSaleAdapter extends RecyclerView.Adapter<ItemHotSaleAdapter.ViewHolder> {

    private List<String> datas = null;

    public ItemHotSaleAdapter(List<String> datas) {
        this.datas = datas;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.item_hot_sale, viewGroup,
                false);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener {
        ...
        public ViewHolder(View view) {
            ...
            mRootView = view.findViewById(R.id.item_hot_sale);
